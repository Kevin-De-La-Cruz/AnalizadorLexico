...
public class ValidacionDireccionesPaginasWeb {
    ...
    public static void main(String[] args) {
        String texto = "Este es un texto de ejemplo que contiene algunas direcciones de paginas www.google.com web.\n"
                + "Puedes encontrar URLs como https://www.ejemplo.com, http://www.otra-url.com,\n"
                + "\n"
                + "o incluso www.sitio-web.org. Asegurate de buscar todas las URLs, independien-\n"
